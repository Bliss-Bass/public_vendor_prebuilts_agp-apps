...
echo -e "${YELLOW}# grabbing latest garlic-player${NC}"

downloadFromRepo "$izzy" "$izzy_dir" com.sagiadinos.garlic.player
...
rm -rf ../../garlic_player/bin ../../garlic_player/Android.mk ../../garlic_player/permissions ../../apps.mk

mv -f Android.mk ../../garlic_player/
mv -f permissions ../../garlic_player/
mv -f bin ../../garlic_player/
mv -f apps.mk ../../
