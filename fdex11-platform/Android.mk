...
include $(CLEAR_VARS)
LOCAL_MODULE := fdex11
LOCAL_SRC_FILES := fdex11.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_CLASS := APPS
LOCAL_PRIVILEGED_MODULE := true
LOCAL_PRODUCT_MODULE := true
LOCAL_REQUIRED_MODULES := com.fde.x11-permissions.xml whitelist-com.fde.x11.xml
LOCAL_OPTIONAL_USES_LIBRARIES := androidx.window.extensions androidx.window.sidecar
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE := com.fde.x11-permissions.xml
...
include $(CLEAR_VARS)
LOCAL_MODULE := whitelist-com.fde.x11.xml
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
